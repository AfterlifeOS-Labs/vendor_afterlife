...
CURRENT_DEVICE := $(subst afterlife_,,$(TARGET_PRODUCT))
...
AFTERLIFE_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(AFTERLIFE_VERSION_CODENAME)-$(CURRENT_DEVICE)-$(AFTERLIFE_BUILDTYPE)-$(shell date -u +%Y%m%d-%H%M)
...
PRODUCT_PRODUCT_PROPERTIES += \
    ...
    ro.afterlife.version.codename=$(AFTERLIFE_VERSION_CODENAME) \
...
ifneq (,$(wildcard vendor/afterlife/signing/keys/otakey.x509.pem))
PRODUCT_OTA_PUBLIC_KEYS := vendor/afterlife/signing/keys/otakey.x509.pem
endif
endif
