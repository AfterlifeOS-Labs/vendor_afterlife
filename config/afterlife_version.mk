...
AFTERLIFE_VERSION_SUFFIX := $(AFTERLIFE_BUILD_TYPE)-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)_$(AFTERLIFE_CODENAME)

# Internal version
AFTERLIFE_VERSION := $(AFTERLIFE_VERSION_SUFFIX)-$(AFTERLIFE_BUILD_DATE)-$(AFTERLIFE_ZIP_TYPE)
